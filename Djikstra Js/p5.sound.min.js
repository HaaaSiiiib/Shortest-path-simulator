				...
				(p5.Oscillator = function (t, e) {
					...
					(p5.Oscillator.prototype.start = function (t, e) {
						...
						if (!this.started) {
							...
							(this.oscillator =
								s.audiocontext.createOscillator()),
				...
				window,
					window.hasOwnProperty("webkitAudioContext") &&
						...
						(AudioContext.prototype.createDynamicsCompressor =
							function () {
								var t =
									this.internal_createDynamicsCompressor();
								return (
									n(t.threshold),
									n(t.knee),
									n(t.ratio),
			...
			void 0 ===
				(o = function (o) {
					(o.Frequency = function (t, e) {
						...
						(o.Frequency.prototype._primaryExpressions =
							Object.create(
							...
							window.navigator.mediaDevices
								...
								.then(function (t) {
									(i.stream = t),
										(i.enabled = !0),
										(i.mediaStream =
											r.audiocontext.createMediaStreamSource(
												t
											)),
		...
		void 0 ===
			(n = function (t) {
				...
				var n = o(15),
					i = o(1);
				return (
					((e.prototype = Object.create(n.prototype)).amp =
						function () {}),
			...
			(i = function (t) {
				...
				return (
					(p5.Compressor = function () {
						e.call(this),
							(this.compressor =
								this.ac.createDynamicsCompressor()),
